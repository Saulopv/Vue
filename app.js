...
app.get('/', function (req, res) {
  res.sendFile(path.join(__dirname, 'views/inlogg.html'));
});
...
Data.prototype.addInfo = function (order){

  this.orderInfo[0] = order;
};
Data.prototype.sendGoodsInfo = function (){
...
io.on('connection', function (socket) {
  ...
  socket.on('sendInfo', function (order) {
    data.addInfo(order);
  });
